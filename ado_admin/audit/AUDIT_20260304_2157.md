...
6. **Configure Grace's capacity** and assign her initial work items.
7. **Expand activity types** beyond "Documentation" to better reflect actual work categories.
8. **Implement Definition of Ready** requiring estimation, acceptance criteria, and parent feature before iteration commitment.
9. **Review #199334 completion** — if tasks carry over, properly size and plan the remaining payments.

### Medium-Term (PI 7 Preparation)

10. **Implement WSJF** at Feature level with Business Value, Time Criticality, Risk Reduction, and Job Size.
11. **Track velocity baseline** — Iteration 6.4 will produce the team's first measurable velocity data point.
12. **Address stalled safety Features** — fire exit canopy (#158382), jockey pump (#176942).

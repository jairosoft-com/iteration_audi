...
7. **Configure Grace's capacity** — This has been unresolved for 3 audits. Set daily hours, activity type, and assign 2–3 starter stories at the beginning of 6.5.
8. **Run Iteration 6.4 Retrospective** — Document the team's outstanding responsiveness to audit findings as a team strength. Address capacity planning as the primary improvement area.
9. **Implement Definition of Ready** — Estimation, acceptance criteria, and parent feature linkage before iteration commitment.
10. **Plan carry-over handling** — If #197122 does not close, formally document it as a carry-over into 6.5 with updated description.

### Medium-Term (PI 7 Preparation)

11. **Implement WSJF at Feature level** — Business Value, Time Criticality, Risk Reduction, Job Size. Feature backlog currently has no prioritization data (Finding F6).
12. **Velocity baseline for 6.5 planning** — Use Iteration 6.4 actual velocity (~33–36 SP) as the baseline for 6.5 commitment.
13. **Address stalled safety Features** — Fire exit canopy (#158382), jockey pump (#176942), and signage permit (#170869) remain structurally blocked.
14. **PI 2 gap and PI 5 incomplete structure** — Review whether historical PI gaps need to be addressed or archived (Finding F7).

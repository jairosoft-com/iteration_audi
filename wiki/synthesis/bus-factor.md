...
| [[entities/team-git-cc-dev]] | **3** *(escalated — Iter 7.4)* | **3** | Iter 7.4: Paul sole owner 31 SP (all 7 Enablers + auth blockers); Kyaa-A defects only. Review still `raseniero`. |

...
- [ ] **Define SAFe work-item mix thresholds** — Add explicit rules for when the iteration mix of user stories, enablers, spikes, defects, and other item types is compliant, borderline, or non-compliant.
- [ ] **Define Definition of Ready rules by work-item type** — Add required fields and minimum readiness criteria for each in-scope ADO work item type so DoR findings are deterministic instead of subjective.

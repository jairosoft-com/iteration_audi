...
1. **Mandatory 7.2 planning decision on carry-over items.** Karl Caumban must make explicit commit/defer calls for each of the 14 QA-Testing SP and 8 Active-state SP:

...
1. **Resolve 6.6 IP orphaned items.** Close Samantha's Spikes (#202144, #202146, #202147) as complete or carry forward. Verify whether #201857 should stay in 6.6 IP or move to 7.1.

2. **Start Teofilo's Training items.** #201865 and #202385 are both New — Teofilo should move them to Active and begin work. His 6h/day capacity is underutilized.

3. **Prioritize armelita's 14-item list.** With 31 SP assigned, she is at capacity. Identify 2–3 items that could be deferred to 7.2 if sprint progress falls behind.

### P2 — This Sprint

1. **Groom root-level Coursewares.** 10 Courseware items at root level remain unscheduled. Assign to future PI7 iterations or archive if superseded. This will improve Iteration Planning numerator ratio.

2. **Establish PI7 objectives.** Link sprint work to PI objectives for strategic alignment visibility.

### P3 — Structural

1. **Groom #193239 (SAFe AI Native Foundation Courseware)** — add Description and AC before scheduling in any sprint.

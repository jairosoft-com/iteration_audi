...
2. **Implement a "Closure SLA."** Stories with all tasks Closed should be moved to Closed within 24 hours. The 10-day closure gap on visa stories is unacceptable by SAFe standards.
3. **Lock sprint scope after Day 2.** The late addition of #201373 on Day 14 (even to capture retroactive work) inflates commitment and distorts velocity metrics.
4. **Document task changes.** Task removals (7 in this iteration) should have comments explaining why they were pruned.
5. **Address Ramon's capacity** — 13 audits at 0 hrs. Either assign capacity or formally document this as a structural decision.

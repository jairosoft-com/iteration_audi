...
3. **Assign the 9 root-level items to future iterations.** Items 202104, 202109, 202114, 201273, 202349 should be assigned to 7.2 or beyond. Items 202017, 202022, 202039, 202042 may be closeable as duplicates.

4. **Begin closing items this week.** Three items are Active; target closure of at least 5 items by Day 7 (Apr 13) to build Delivery Predictability momentum. Historically, HR closures accelerate in the final sprint days — earlier closure would reduce end-of-sprint risk.

### P2 — PI7 Planning

5. **Add Spike items for research-heavy work.** The SL Cash Conversion workflow (Data Reconciliation, Cash Calculation, Finance Export) involves process design — a Spike or Enabler would be appropriate and would improve Work Item Balance from 70 to potentially higher.

6. **Define PI7 objectives and link Features.** Map stories to Features and Features to PI objectives for strategic alignment visibility.

### P3 — Structural

7. **Address Grace's team membership.** Grace has had 0 capacity for 26 consecutive audits. Either assign capacity or remove from team roster.

8. **Cross-train or delegate HR tasks.** Reduce bus factor by involving at least one backup for HR administrative tasks.

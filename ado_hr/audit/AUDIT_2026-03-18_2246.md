...
1. **Define an iteration goal for 6.6 before planning starts.** This has been missing for 12 consecutive audits. It should be a mandatory prerequisite.

2. **Link Features to PI Objectives.** Also missing for 12 audits. Escalate to program level if the team cannot address independently.

3. **Use Iteration 6.5's velocity data for 6.6 planning.** Demonstrated velocity: ~4.1 SP/day when actively delivering (29 SP in 7 effective days). Plan 6.6 at 30-35 SP commitment with WIP limits of 3-5.

4. **Conduct a Sprint Retrospective** focused on the 5-day stall and the subsequent burst recovery. Key learning: high WIP causes paralysis; batch-closing by Feature restores flow.
